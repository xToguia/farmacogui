...
// Substituem emojis por ícones mais profissionais
...
export const PillIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <path d="M10.5 20.5 21 10a2.828 2.828 0 1 0-4-4L6.5 16.5" />
    <path d="m15 9-3 3" />
    <path d="M3 21a2.828 2.828 0 1 0 4-4L3 21Z" />
  </svg>
);
...
export const TruckIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export const LayoutDashboardIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export const SettingsIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    <path d="m4.14 4.14 4.24 4.24m7.24 7.24 4.24 4.24" />
  </svg>
);
